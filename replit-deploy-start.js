/**
 * Скрипт для запуска деплоя NovaAI University на Replit
...
// Используем npx tsx для запуска TypeScript файлов
const backendServer = spawn('npx', ['tsx', 'server/index.ts'], {
  stdio: 'inherit',
