...
-- Generated on 2025-06-22T21:03:13.687Z
...
VALUES (1, 'Машинное обучение: От основ к практике', 'machine-learning-complete', 'Полный курс машинного обучения от базовых концепций до реальных проектов', 'intermediate', '12 weeks', '{machine-learning,python,data-science,ai}', NOW(), NOW());

INSERT INTO courses (id, title, slug, description, difficulty, duration, tags, created_at, updated_at)
VALUES (2, 'Глубокое обучение и нейронные сети', 'deep-learning-fundamentals', 'Современные архитектуры нейронных сетей и их применения', 'advanced', '16 weeks', '{deep-learning,neural-networks,tensorflow,pytorch}', NOW(), NOW());

INSERT INTO courses (id, title, slug, description, difficulty, duration, tags, created_at, updated_at)
VALUES (3, 'Computer Vision: От классических методов к современным архитектурам', 'computer-vision-complete', 'Полный курс компьютерного зрения с практическими проектами', 'intermediate', '14 weeks', '{computer-vision,cnn,image-processing,opencv}', NOW(), NOW());

INSERT INTO courses (id, title, slug, description, difficulty, duration, tags, created_at, updated_at)
VALUES (4, 'Natural Language Processing: Современные подходы', 'nlp-modern-approaches', 'От традиционных методов NLP к трансформерам и языковым моделям', 'advanced', '18 weeks', '{nlp,transformers,bert,gpt,language-models}', NOW(), NOW());

INSERT INTO courses (id, title, slug, description, difficulty, duration, tags, created_at, updated_at)
VALUES (5, 'AI для бизнеса: Практическое применение', 'ai-for-business', 'Как внедрить ИИ в бизнес-процессы и получить конкурентные преимущества', 'beginner', '8 weeks', '{business,ai-strategy,automation,roi}', NOW(), NOW());


-- Insert modules and lessons

INSERT INTO course_modules (id, course_id, title, description, order_index, created_at, updated_at)
VALUES (1, 1, 'Введение в машинное обучение', 'Основные концепции и терминология ML', 1, NOW(), NOW());


INSERT INTO lessons (module_id, title, type, content, duration, order_index, created_at, updated_at)
VALUES (1, 'Что такое машинное обучение?', 'text', $LESSON_CONTENT_0_0_0$# Что такое машинное обучение?
...
3. Какой тип ML подойдет для решения$LESSON_CONTENT_0_0_0$, 45, 1, NOW(), NOW());

INSERT INTO lessons (module_id, title, type, content, duration, order_index, created_at, updated_at)
VALUES (1, 'История и эволюция ML', 'text', $LESSON_CONTENT_0_0_1$# История и эволюция машинного обучения
...
3. Подумайте о потенциальных применениях в вашей области$LESSON_CONTENT_0_0_1$, 30, 2, NOW(), NOW());


INSERT INTO course_modules (id, course_id, title, description, order_index, created_at, updated_at)
VALUES (2, 1, 'Подготовка данных и анализ', 'Работа с данными: очистка, анализ, подготовка', 2, NOW(), NOW());


INSERT INTO lessons (module_id, title, type, content, duration, order_index, created_at, updated_at)
VALUES (2, 'Исследовательский анализ данных (EDA)', 'interactive', $LESSON_CONTENT_0_1_0$# Исследовательский анализ данных (EDA)
...
Помните: EDA — это итеративный процесс. Чем лучше вы понимаете свои данные, тем лучше будут ваши модели!$LESSON_CONTENT_0_1_0$, 60, 1, NOW(), NOW());


INSERT INTO course_modules (id, course_id, title, description, order_index, created_at, updated_at)
VALUES (11, 2, 'Основы нейронных сетей', 'Математические основы и базовые архитектуры', 1, NOW(), NOW());


INSERT INTO lessons (module_id, title, type, content, duration, order_index, created_at, updated_at)
VALUES (11, 'Математические основы нейронных сетей', 'text', $LESSON_CONTENT_1_0_0$# Математические основы нейронных сетей
...
В следующем уроке мы изучим современные фреймворки для глубокого обучения и построим первые практические модели.$LESSON_CONTENT_1_0_0$, 90, 1, NOW(), NOW());


INSERT INTO course_modules (id, course_id, title, description, order_index, created_at, updated_at)
VALUES (21, 3, 'Основы обработки изображений', 'Классические методы и фундаментальные концепции', 1, NOW(), NOW());


INSERT INTO lessons (module_id, title, type, content, duration, order_index, created_at, updated_at)
VALUES (21, 'Цифровые изображения и их представление', 'interactive', $LESSON_CONTENT_2_0_0$# Цифровые изображения и их представление
...
В следующем уроке мы изучим фильтрацию изображений и выделение границ!$LESSON_CONTENT_2_0_0$, 75, 1, NOW(), NOW());


INSERT INTO course_modules (id, course_id, title, description, order_index, created_at, updated_at)
VALUES (31, 4, 'Основы обработки естественного языка', 'Фундаментальные концепции и традиционные методы', 1, NOW(), NOW());


INSERT INTO lessons (module_id, title, type, content, duration, order_index, created_at, updated_at)
VALUES (31, 'Введение в NLP и предобработка текста', 'text', $LESSON_CONTENT_3_0_0$# Введение в обработку естественного языка (NLP)
...
В следующем уроке мы изучим векторные представления слов и методы их создания!$LESSON_CONTENT_3_0_0$, 60, 1, NOW(), NOW());


INSERT INTO course_modules (id, course_id, title, description, order_index, created_at, updated_at)
VALUES (41, 5, 'Стратегия внедрения ИИ', 'Планирование и стратегия цифровой трансформации', 1, NOW(), NOW());


INSERT INTO lessons (module_id, title, type, content, duration, order_index, created_at, updated_at)
VALUES (41, 'ИИ-стратегия компании: с чего начать', 'text', $LESSON_CONTENT_4_0_0$# ИИ-стратегия компании: с чего начать
...
В следующем уроке мы изучим конкретные кейсы успешного внедрения ИИ в различных отраслях.$LESSON_CONTENT_4_0_0$, 45, 1, NOW(), NOW());
