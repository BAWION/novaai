...
- June 24, 2025: Расширена админ-панель + добавлены 20 идей новых курсов
  - Добавлен раздел "Архитектура курсов" с детальной статистикой готовности каждого курса
  - Создан раздел "Планирование" с формой добавления идей курсов и приоритизацией
  - В план добавлено 20 востребованных курсов: Telegram-боты, сайты с Cursor+AI, автоматизация Make.com+ChatGPT
  - Курсы по TikTok+CapCut, Midjourney+Canva, Notion AI, стартапы без кода, продвинутые промпты
  ...
  - План развития: 20 новых курсов с приоритизацией по спросу и сложности реализации
