...
- 2025-06-29: ИСПРАВЛЕНО ПОНИМАНИЕ TELEGRAM АВТОРИЗАЦИИ
  - Выяснено, что текущий TELEGRAM_BOT_TOKEN предназначен для публикации новостей в канал @humanreadytech
  - Убрана неработающая Telegram авторизация с неправильным токеном
  - Добавлено информационное уведомление о будущей реализации Telegram входа
  - Для реальной Telegram авторизации потребуется создание отдельного бота с настройкой домена
  - Платформа работает стабильно с email авторизацией
