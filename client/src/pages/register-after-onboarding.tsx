  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center p-4">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-white mb-4">RegisterAfterOnboarding</h1>
        <p className="text-blue-200 mb-8">Страница register-after-onboarding Galaxion</p>
