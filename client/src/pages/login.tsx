            ...
            {!showLoginForm ? (
              <>
                <div className="mb-6 flex justify-center">
                  <button
                    onClick={() => window.open('https://t.me/Galaxion_Auth_bot', '_blank')}
                    disabled={isLoggingIn}
                    className="bg-[#0088cc] hover:bg-[#006aa3] text-white py-3 px-4 rounded-lg font-medium transition duration-300 flex items-center justify-center tap-highlight-none btn-mobile disabled:opacity-50 w-full max-w-xs"
                  >
