...
export default function BusinessAIOverview() {
  ...
  const industryHeatmap = [
    { name: 'Финансы & FinTech', level: 85, color: 'from-green-500 to-emerald-500' },
    { name: 'Розничная торговля', level: 75, color: 'from-blue-500 to-teal-500' },
    { name: 'Телекоммуникации', level: 70, color: 'from-[#6E3AFF] to-[#2EBAE1]' },
    { name: 'Здравоохранение', level: 65, color: 'from-purple-500 to-pink-500' },
    { name: 'Производство', level: 60, color: 'from-orange-500 to-amber-500' },
    { name: 'Логистика', level: 55, color: 'from-indigo-500 to-blue-500' },
    { name: 'Энергетика', level: 50, color: 'from-yellow-500 to-orange-500' },
    { name: 'Образование', level: 45, color: 'from-pink-500 to-red-500' },
    { name: 'Недвижимость', level: 40, color: 'from-emerald-500 to-lime-500' },
    { name: 'Госсектор', level: 35, color: 'from-slate-500 to-gray-500' },
  ];
  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        >
          <Glassmorphism className="p-6 md:p-8 rounded-xl border-l-4 border-l-[#6E3AFF]">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              <div className="flex-1">
                <h2 className="text-2xl font-orbitron font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#B28DFF] via-[#8BE0F7] to-[#B28DFF]">
                  Трансформируйте бизнес с ИИ
                </h2>
                ...
                <div className="flex flex-wrap gap-3">
                  <Button className="bg-gradient-to-r from-[#6E3AFF] to-[#2EBAE1] hover:from-[#5E2AFF] hover:to-[#1E9AE1]">
              ...
              <div className="w-full md:w-2/5 lg:w-1/3 aspect-video bg-space-700/50 rounded-lg flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {industryHeatmap.map((industry, index) => (
                <motion.div
                  ...
                  className="bg-space-800/40 rounded-lg p-4 border border-white/5 hover:border-white/20 transition-all cursor-pointer"
                >
                  <div className="flex justify-between mb-2">
                    <h4 className="font-medium">{industry.name}</h4>
                    <span className="font-orbitron text-white/90">{industry.level}%</span>
                  </div>
            ...
            {businessSections.map((section, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#6E3AFF]/20 to-[#2EBAE1]/10 flex items-center justify-center text-[#8BE0F7]">
                ...
                <Link href={section.to}>
                  <Button className="w-full bg-space-700 hover:bg-space-600 border border-white/10">
                    {section.buttonText}
          ...
          <Glassmorphism className="p-6 rounded-xl">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="w-full md:w-1/3">
                <div className="aspect-square rounded-xl bg-gradient-to-br from-[#6E3AFF]/20 to-[#2EBAE1]/10 flex flex-col items-center justify-center p-6 text-center">
              ...
              <div className="w-full md:w-2/3">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center text-white text-xs mr-3 mt-0.5">1</div>
                    <div>
                  ...
                  <li className="flex items-start">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-r from-[#6E3AFF] to-[#2EBAE1] flex items-center justify-center text-white text-xs mr-3 mt-0.5">2</div>
                    <div>
                  ...
                  <li className="flex items-start">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 flex items-center justify-center text-white text-xs mr-3 mt-0.5">3</div>
                    <div>
                  ...
                  <li className="flex items-start">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white text-xs mr-3 mt-0.5">4</div>
                    <div>
                  ...
                  <li className="flex items-start">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-teal-500 flex items-center justify-center text-white text-xs mr-3 mt-0.5">5</div>
                    <div>
